 ...
 */
case class mhzSwitch(setupID: String, _keepStatus: Boolean, _name: String, private var _systemCode: String, private var _unitCode: String) extends Switch(setupID, _keepStatus,_name) {
